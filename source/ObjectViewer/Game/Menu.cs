					...
					if (menu.Items[menu.Selection] is MenuCommand menuItem)
					{
						switch (menuItem.Tag)
						{
							...
							case MenuTag.ObjectList:             // TO OBJECT LIST MENU
								...
								Program.CurrentHost.RegisterTexture(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\please_select.png"), TextureParameters.NoChange, out filePictureBox.Texture);
								break;
