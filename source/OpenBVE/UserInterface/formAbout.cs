...
namespace OpenBve
{
	internal partial class formAbout : Form
	{
		public formAbout()
		{
			InitializeComponent();
			ApplyLanguage();
			labelProductName.Text = Translations.GetInterfaceString(HostApplication.OpenBve, new string[] {"program_title"}) + @" v" + Application.ProductVersion + Program.VersionSuffix;
			try
			{
