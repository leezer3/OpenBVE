...
namespace OpenBveApi.Objects
{
	...
	{
		/// <summary>The current host interface</summary>
		...
		/// <summary>Creates a new static object</summary>
		/// <param name="Host">A reference to the host interface of the executing application</param>
		...
		{
			//Non-public ctor used for cloning
		}
		...
		/// <returns></returns>
		public StaticObject Clone(Textures.Texture DaytimeTexture, Textures.Texture NighttimeTexture) //BUG: Makefile requires these to be fully qualified
		{
		...
		/// <summary>Joins the StaticObject passed via add to this object</summary>
		/// <param name="Add">The object to add</param>
		...
		/// <remarks>1.0 is the nominal scale to apply no changes</remarks>
		...
		/// <summary>Applys rotation to the object</summary>
		/// <param name="Rotation">A 3D vector describing the rotation</param>
		...
		/// <summary>Aoplies translation</summary>
		/// <param name="x">The amount to translate by in the X-axis</param>
		/// <param name="y">The amount to translate by in the Y-axis</param>
		/// <param name="z">The amount to translate by in the Z-axis</param>
		...
		/// <summary>Mirrors the object</summary>
		/// <param name="vX">Whether the X coordinates are to be mirrored</param>
		/// <param name="vY">Whether the Y coordinates are to be mirrored</param>
		/// <param name="vZ">Whether the Z coordinates are to be mirrored</param>
		/// <param name="nX">Whether the X normal coordinates are to be mirrored</param>
		/// <param name="nY">Whether the Y normal coordinates are to be mirrored</param>
		/// <param name="nZ">Whether the Z normal coordinates are to be mirrored</param>
		...
		/// <summary>Applies shear to the object</summary>
		/// <param name="d"></param>
		/// <param name="s"></param>
		/// <param name="r"></param>
		...
		/// <param name="ViewingDistance">The absolute world viewing distance</param>
		/// BUG: The group indicies are not regenerated if the viewing distance changes
		/// Note that there is no supported way to change viewing distance in-game, so this doesn't really matter
		public void ApplyData(StaticObject Prototype, Vector3 Position, Transformation BaseTransformation, Transformation AuxTransformation, bool AccurateObjectDisposal, double AccurateObjectDisposalZOffset, double startingDistance, double endingDistance, double BlockLength, double TrackPosition, double Brightness, bool DuplicateMaterials, double ViewingDistance)
		{
			...
			if (BlockLength != 0.0)
			{
				checked
				{
					GroupIndex = (short) Mod(System.Math.Floor(StartingDistance / BlockLength), System.Math.Ceiling(ViewingDistance / BlockLength));
				}
			}
		}
		...
		/// <summary>The callback function to the current host, creating the object within the world</summary>
		/// <param name="Position"></param>
		/// <param name="BaseTransformation"></param>
		/// <param name="AuxTransformation"></param>
		/// <param name="SectionIndex"></param>
		/// <param name="AccurateObjectDisposal"></param>
		/// <param name="StartingDistance"></param>
		/// <param name="EndingDistance"></param>
		/// <param name="BlockLength"></param>
		/// <param name="TrackPosition"></param>
		/// <param name="Brightness"></param>
		/// <param name="DuplicateMaterials"></param>
		...
		{
			currentHost.CreateStaticObject(this, Position, BaseTransformation, AuxTransformation, AccurateObjectDisposal, 0.0, StartingDistance, EndingDistance, BlockLength, TrackPosition, Brightness, DuplicateMaterials);
		}

		/// <summary>Runs various optimizations on the object</summary>
		/// <param name="PreserveVerticies">Whether duplicate vertices are to be preserved</param>
