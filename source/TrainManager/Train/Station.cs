			...
			else if (direction > 0)
			{
				if (Station == stationIndex)
				{
					if (IsPlayerTrain)
					{
						...
						{
							string s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_passed");
						...
						{
							string s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_passed_boarding");
							s = s.Replace("[name]", TrainManagerBase.CurrentRoute.Stations[stationIndex].Name);
						...
						if (CurrentSpeed > -0.277777777777778 & CurrentSpeed < 0.277777777777778)
						{
							...
							if (left & right)
							{
								...
								if (IsPlayerTrain)
								{
									...
									if (early < -1.0)
									{
										s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_arrival_late");
									}
									else if (early > 1.0)
									{
										s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_arrival_early");
									}
									else
									{
										s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_arrival");
									}
									...
									{
										s += Translations.GetInterfaceString(HostApplication.OpenBve, "message_delimiter") + Translations.GetInterfaceString(HostApplication.OpenBve, CurrentDirection == TrackDirection.Forwards ? "message_station_overrun" : "message_station_underrun");
									}
									else if (StationDistanceToStopPoint > 0.1)
									{
										s += Translations.GetInterfaceString(HostApplication.OpenBve, "message_delimiter") + Translations.GetInterfaceString(HostApplication.OpenBve, CurrentDirection == TrackDirection.Forwards ? "message_station_underrun" : "message_station_overrun");
									}
									...
									{
										s += Translations.GetInterfaceString(HostApplication.OpenBve, "message_delimiter") + Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_terminal");
									}
									...
									{
										s = Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_deadline");
							...
							if (TrainManagerBase.CurrentRoute.SecondsSinceMidnight > StationDepartureTime && (TrainManagerBase.CurrentRoute.Stations[i].Type != StationType.Terminal || IsPlayerTrain == false))
							{
								...
								switch (TrainManagerBase.CurrentRoute.Stations[i].Type)
								{
									case StationType.Normal:
										...
										{
											TrainManagerBase.currentHost.AddMessage(Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_depart"), MessageDependency.None, GameMode.Normal, MessageColor.White, TrainManagerBase.CurrentRoute.SecondsSinceMidnight + 5.0, null);
										}
										else
										{
											TrainManagerBase.currentHost.AddMessage(Translations.GetInterfaceString(HostApplication.OpenBve, "message_station_depart_closedoors"), MessageDependency.None, GameMode.Normal, MessageColor.White, TrainManagerBase.CurrentRoute.SecondsSinceMidnight + 5.0, null);
										}
