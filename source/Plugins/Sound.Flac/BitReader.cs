		...
		internal uint ReadBits(int number)
		{
			if (this.BitPosition == 7)
			{
				...
				if ((number & 7) == 0)
				{
					...
					if (number == 24)
					{
						return ((uint)this.Bytes[this.BytePosition++] << 16) | ((uint)this.Bytes[this.BytePosition++] << 8)
						       | (uint)this.Bytes[this.BytePosition++];
					}

					return ((uint)this.Bytes[this.BytePosition++] << 24) | ((uint)this.Bytes[this.BytePosition++] << 16)
					       | ((uint)this.Bytes[this.BytePosition++] << 8) | (uint)this.Bytes[this.BytePosition++];
				}
				...
				if (number < 16)
				{
					...
					return ((uint)this.Bytes[this.BytePosition++] << (number - 8))
					       | ((uint)this.Bytes[this.BytePosition] >> (16 - number));
				}
				...
				if (number < 24)
				{
					...
					return ((uint)this.Bytes[this.BytePosition++] << (number - 8))
					       | ((uint)this.Bytes[this.BytePosition++] << (number - 16))
					       | ((uint)this.Bytes[this.BytePosition] >> (24 - number));
				}

				this.BitPosition = 31 - number;
				return ((uint)this.Bytes[this.BytePosition++] << (number - 8))
				       | ((uint)this.Bytes[this.BytePosition++] << (number - 16))
				       | ((uint)this.Bytes[this.BytePosition++] << (number - 24))
				       | ((uint)this.Bytes[this.BytePosition] >> (32 - number));
			}
			...
			if (((number - this.BitPosition - 1) & 7) == 0)
			{
				...
				if (number < 16)
				{
					...
					this.BitPosition = 7;
					return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (number - 8)) - 1)) << 8)
					       | (uint)this.Bytes[this.BytePosition++];
				}
				...
				{
					this.BitPosition = 7;
					return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (number - 16)) - 1)) << 16)
					       | ((uint)this.Bytes[this.BytePosition++] << 8) | (uint)this.Bytes[this.BytePosition++];
				}

				this.BitPosition = 7;
				return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (number - 24)) - 1)) << 24)
				       | ((uint)this.Bytes[this.BytePosition++] << 16) | ((uint)this.Bytes[this.BytePosition++] << 8)
				       | (uint)this.Bytes[this.BytePosition++];
			}
			...
			if (bytes < 3)
			{
				...
				return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (this.BitPosition + number - 7)) - 1))
				        << (7 - this.BitPosition)) | ((uint)this.Bytes[this.BytePosition] >> (this.BitPosition + 1));
			}
			...
			if (bytes < 5)
			{
				if (bytes == 3)
				{
					...
					return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (this.BitPosition + number - 15)) - 1))
					        << (15 - this.BitPosition)) | ((uint)this.Bytes[this.BytePosition++] << (7 - this.BitPosition))
					       | ((uint)this.Bytes[this.BytePosition] >> (this.BitPosition + 1));
				}

				this.BitPosition -= number - 24;
				return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (this.BitPosition + number - 23)) - 1))
				        << (23 - this.BitPosition)) | ((uint)this.Bytes[this.BytePosition++] << (15 - this.BitPosition))
				       | ((uint)this.Bytes[this.BytePosition++] << (7 - this.BitPosition))
				       | ((uint)this.Bytes[this.BytePosition] >> (this.BitPosition + 1));
			}

			this.BitPosition -= number - 32;
			return (((uint)this.Bytes[this.BytePosition++] & (((uint)1 << (this.BitPosition + number - 31)) - 1))
			        << (31 - this.BitPosition)) | ((uint)this.Bytes[this.BytePosition++] << (23 - this.BitPosition))
			       | ((uint)this.Bytes[this.BytePosition++] << (15 - this.BitPosition))
			       | ((uint)this.Bytes[this.BytePosition++] << (7 - this.BitPosition))
			       | ((uint)this.Bytes[this.BytePosition] >> (this.BitPosition + 1));
		}
