					...
					for (int j = 0; j < Data.Blocks[i].Switches.Length; j++)
					{
						if (Data.Blocks[i].Switches[j] != null)
						{
							...
							if (Data.Blocks[i].Switches[j].Trailing == false)
							{
								...
								CurrentRoute.Switches.Add(newSwitch, new RouteManager2.Tracks.Switch(new[] { j, Data.Blocks[i].Switches[j].SecondTrack }, Data.Blocks[i].Switches[j].TrackNames, Data.Blocks[i].Switches[j].InitialSetting, CurrentRoute.Tracks[0].Elements[n].StartingTrackPosition, type,  Data.Blocks[i].Switches[j].Name));
							...
							else
							{
								...
								CurrentRoute.Switches.Add(newSwitch, new RouteManager2.Tracks.Switch(new[] { Data.Blocks[i].Switches[j].SecondTrack, j }, Data.Blocks[i].Switches[j].TrackNames, Data.Blocks[i].Switches[j].InitialSetting, CurrentRoute.Tracks[0].Elements[n].StartingTrackPosition, type,  Data.Blocks[i].Switches[j].Name));
								//Assign trailing switch event
								int l = CurrentRoute.Tracks[j].Elements[n].Events.Length;
