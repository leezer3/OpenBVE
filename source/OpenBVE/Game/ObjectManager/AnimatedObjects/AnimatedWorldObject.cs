namespace OpenBve
{
	...
	public static partial class ObjectManager
	{
		...
		private class AnimatedWorldObjectStateSound : WorldObject
		{
			...
			private Sounds.SoundSource SoundSource;
			...
			internal override void Update(double TimeElapsed, bool ForceUpdate)
			{
				...
				if (visible | ForceUpdate)
				{
					if (Object.SecondsSinceLastUpdate >= Object.RefreshRate | ForceUpdate)
					{
						...
						{
							this.SoundSource = Sounds.PlaySound(this.Object.StateChangeSoundBuffer, 1.0, 1.0, this.Position, false);
						}
					}
					else
					{
