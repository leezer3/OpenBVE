...
namespace OpenBveShared
{
	public static partial class Renderer
	{
		...
		public static Size MeasureString(Fonts.OpenGlFont font, string text)
		{
			int width = 0;
			int height = 0;
		...
		public static void DrawString(Fonts.OpenGlFont font, string text, Point location, TextAlignment alignment, Color128 color)
		{
			if (text == null || font == null)
			{
				return;
		...
		/// <remarks>This function sets the OpenGL blend function to glBlendFunc(Gl.GL_SRC_ALPHA, Gl.GL_ONE_MINUS_SRC_ALPHA).</remarks>
		public static void DrawString(Fonts.OpenGlFont font, string text, Point location, TextAlignment alignment, Color128 color, bool shadow)
		{
