...
namespace OpenBve {
	internal partial class formMain {
		...
		private void UpdateControlListElement(ListViewItem Item, int Index, bool ResizeColumns)
		{
			...
			switch (Info.Type) {
					case Translations.CommandType.Digital: Item.SubItems[1].Text = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_list_type_digital"); break;
					case Translations.CommandType.AnalogHalf: Item.SubItems[1].Text = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_list_type_analoghalf"); break;
					case Translations.CommandType.AnalogFull: Item.SubItems[1].Text = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_list_type_analogfull"); break;
		...
		private string GetControlDetails(int Index) {
			...
			string Separator = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_separator");
			if (Interface.CurrentControls[Index].Method == ControlMethod.Keyboard) {
				string t = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_keyboard") + Separator;
				if ((Interface.CurrentControls[Index].Modifier & KeyboardModifier.Shift) != 0) t += Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_keyboard_shift");
				if ((Interface.CurrentControls[Index].Modifier & KeyboardModifier.Ctrl) != 0) t += Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_keyboard_ctrl");
				if ((Interface.CurrentControls[Index].Modifier & KeyboardModifier.Alt) != 0) t += Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_keyboard_alt");
			...
			if (Interface.CurrentControls[Index].Method == ControlMethod.Joystick) {
				...
				{
					t = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick").Replace("[index]", Program.Joysticks.AttachedJoysticks[Interface.CurrentControls[Index].Device].Handle + 1.ToString(Culture));
				}
					
				switch (Interface.CurrentControls[Index].Component) {
					case JoystickComponent.Axis:
						t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_axis").Replace("[index]", (Interface.CurrentControls[Index].Element + 1).ToString(Culture));
						if (Interface.CurrentControls[Index].Direction == -1) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_axis_negative");
						} else if (Interface.CurrentControls[Index].Direction == 1) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_axis_positive");
						} else {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_axis_invalid");
						} break;
					case JoystickComponent.Button:
						t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_button").Replace("[index]", (Interface.CurrentControls[Index].Element + 1).ToString(Culture));
						break;
					case JoystickComponent.Hat:
						t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat").Replace("[index]", (Interface.CurrentControls[Index].Element + 1).ToString(Culture));
						if (Interface.CurrentControls[Index].Direction == (int)HatPosition.Left) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_left");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.UpLeft) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_upleft");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.Up) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_up");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.UpRight) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_upright");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.Right) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_right");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.DownRight) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_downright");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.Down) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_down");
						} else if (Interface.CurrentControls[Index].Direction == (int)HatPosition.DownLeft) {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_downleft");
						} else {
							t += Separator + Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_joystick_hat_invalid");
						} break;
				}
				return t;
			} 
			...
			return Translations.GetInterfaceString(HostApplication.OpenBve, "controls_assignment_invalid");
		...
		private void radiobuttonJoystick_CheckedChanged(object sender, EventArgs e) {
			...
			textboxJoystickGrab.Text = Translations.GetInterfaceString(HostApplication.OpenBve, radiobuttonJoystick.Checked ? "controls_selection_joystick_assignment_grab" : "controls_selection_keyboard_assignment_grab");
		}
		...
		private void buttonControlsImport_Click(object sender, EventArgs e) {
			OpenFileDialog Dialog = new OpenFileDialog
			{
				...
				Filter =
					Translations.GetInterfaceString(HostApplication.OpenBve, "dialog_controlsfiles") + @"|*.controls|" +
		...
		private void textboxJoystickGrab_Enter(object sender, EventArgs e) {
			...
			{
				textboxJoystickGrab.Text = Translations.GetInterfaceString(HostApplication.OpenBve, "controls_selection_keyboard_assignment_grabbing");
			...
			textboxJoystickGrab.Text = Translations.GetInterfaceString(HostApplication.OpenBve, FullAxis ? "controls_selection_joystick_assignment_grab_fullaxis" : "controls_selection_joystick_assignment_grab_normal");
			textboxJoystickGrab.BackColor = Color.LightSkyBlue;
			textboxJoystickGrab.ForeColor = Color.Black;
		}
		...
		private void pictureboxJoysticks_Paint(object sender, PaintEventArgs e)
		{
			...
			for (int i = 0; i < Program.Joysticks.AttachedJoysticks.Count; i++)
			{
				...
				if (OpenTK.Configuration.RunningOnSdl2)
				{
					...
					string error = Translations.GetInterfaceString(HostApplication.OpenBve, "errors_controls_ingame");
					if (OpenTK.Configuration.RunningOnSdl2)
					{
