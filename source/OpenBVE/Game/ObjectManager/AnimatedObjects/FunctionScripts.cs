						...
						if (IsPartOfTrain) {
							...
							if (nextSectionIndex >= 0 & nextSectionIndex < Program.CurrentRoute.Sections.Length) {
								...
								if (a >= 0 & a < Program.CurrentRoute.Sections[nextSectionIndex].Aspects.Length) {
									Function.Stack[s] = Program.CurrentRoute.Sections[nextSectionIndex].Aspects[a].AspectNumber;
								} else {
									Function.Stack[s] = 0;
								}
							}
							...
							if (a >= 0 & a < Program.CurrentRoute.Sections[SectionIndex].Aspects.Length) {
								Function.Stack[s] = Program.CurrentRoute.Sections[SectionIndex].Aspects[a].AspectNumber;
							} else {
								Function.Stack[s] = 0;
							}
						} else {
