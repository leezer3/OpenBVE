...
namespace MotorSoundEditor.Systems.Functions
{
	...
	internal static class Plugins
	{
		...
		internal static bool LoadPlugins()
		{
			...
			{
				MessageBox.Show(string.Format("No available texture & sound loader plugins were found.{0} Please re-download openBVE.", Environment.NewLine), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
				return false;
			}
