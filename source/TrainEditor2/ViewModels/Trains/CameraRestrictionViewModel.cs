...
namespace TrainEditor2.ViewModels.Trains
{
	internal class CameraRestrictionViewModel : BaseViewModel
	{
		...
		internal ReactiveProperty<Unit.Length> ForwardsUnit
		{
			get;
		}
		...
		internal ReactiveProperty<Unit.Length> BackwardsUnit
		{
			get;
		}
		...
		internal ReactiveProperty<Unit.Length> LeftUnit
		{
			get;
		}
		...
		internal ReactiveProperty<Unit.Length> RightUnit
		{
			get;
		}
		...
		internal ReactiveProperty<Unit.Length> UpUnit
		{
			get;
		}
		...
		internal ReactiveProperty<Unit.Length> DownUnit
		{
			get;
		}
