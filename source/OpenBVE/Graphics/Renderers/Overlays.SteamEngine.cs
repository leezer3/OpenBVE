...
namespace OpenBve.Graphics.Renderers
{
	internal partial class Overlays
	{
		internal void RenderSteamEngineOverlay()
		{
			...
			string boilerPressure = "Boiler Pressure: " + engine.Boiler.SteamPressure + " of " + engine.Boiler.MaxSteamPressure;
			...
			string steamGenerationRate = "Steam Generation Rate: " + engine.Boiler.SteamGenerationRate;
			...
			string steamUsageRate = "Steam Usage Rate: " + engine.CylinderChest.PressureUse + " per stroke";
			...
			string fireMass = "Fire Mass: " + engine.Boiler.Firebox.FireMass;
			...
			string fireTemp = "Fire Temperature: " + engine.Boiler.Firebox.Temperature;
			...
			string fireArea = "Fire Area: " + engine.Boiler.Firebox.FireArea;
