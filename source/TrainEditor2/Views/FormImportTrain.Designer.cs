namespace TrainEditor2.Views
{
	partial class FormImportTrain
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBoxNewFormat.TabIndex = 44;
			...
			this.groupBoxTrainXml.DragDrop += new System.Windows.Forms.DragEventHandler(this.GroupBoxTrainXml_DragDrop);
			this.groupBoxTrainXml.DragEnter += new System.Windows.Forms.DragEventHandler(this.GroupBoxTrainXml_DragEnter);
			// 
			...
			this.Name = "FormImportTrain";
			this.Text = "Import train file";
			this.Load += new System.EventHandler(this.FormImportTrain_Load);
