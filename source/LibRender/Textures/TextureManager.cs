...
namespace LibRender
{
	...
	public static class TextureManager
	{
		...
		public static Texture[] RegisteredTextures = new Texture[16];

		/// <summary>The number of currently registered textures.</summary>
		public static int RegisteredTexturesCount = 0;
		...
		public static bool RegisterTexture(string path, out Texture handle)
		{
		...
		/// <param name="handle">Receives a handle to the texture.</param>
		/// <returns>Whether registering the texture was successful.</returns>
		public static bool RegisterTexture(string path, TextureParameters parameters, out Texture handle)
		{
		   /* BUG:
			...
			*/
			...
			RegisteredTextures[idx] = new Texture(path, parameters, Renderer.currentHost);
		...
		public static Texture RegisterTexture(Texture texture)
		{
			/*
			 * Register the texture and return the newly created handle.
			 * */
		...
		public static Texture RegisterTexture(Bitmap bitmap, TextureParameters parameters)
		{
			/*
			 * Register the texture and return the newly created handle.
			 * */
		...
		/// <returns>The handle to the texture.</returns>
		/// <remarks>Be sure not to dispose of the bitmap after calling this function.</remarks>
		public static Texture RegisterTexture(Bitmap bitmap)
		{
			/*
			 * Register the texture and return the newly created handle.
			 * */
		...
		/// <returns>The handle to the texture.</returns>
		/// <remarks>Be sure not to dispose of the bitmap after calling this function.</remarks>
		public static Texture RegisterTexture(Bitmap bitmap, Bitmap alpha)
		{
			/*
			 * Register the texture and return the newly created handle.
			 * */
		...
		public static void SaveTexture(string file, Texture texture)
		{
		...
		public static Texture ResizeToPowerOfTwo(Texture texture)
		{
		...
		public static int GetNumberOfRegisteredTextures()
		{
		...
		public static int GetNumberOfLoadedTextures()
		{
			int count = 0;
			for (int i = 0; i < RegisteredTexturesCount; i++)
			{
		...
		public static int GetNextFreeTexture()
		{
