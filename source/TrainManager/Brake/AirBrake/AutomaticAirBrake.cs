...
namespace TrainManager.BrakeSystems
{
	...
	{
		public AutomaticAirBrake(CarBase car, EletropneumaticBrakeType type, double BrakeControlSpeed, double MotorDeceleration, AccelerationCurve[] DecelerationCurves) : base(car)
		{
