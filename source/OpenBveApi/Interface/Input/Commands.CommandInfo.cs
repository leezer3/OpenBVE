...
#pragma warning restore 618			
			...
			{ Command.CameraPreviousPOI, new CommandInfo(Command.CameraPreviousPOI, CommandType.Digital, "CAMERA_POI_PREVIOUS") },
			{ Command.CameraNextPOI, new CommandInfo(Command.CameraNextPOI, CommandType.Digital, "CAMERA_POI_NEXT") },
			...
			{ Command.MiscDistanceToNextStation, new CommandInfo(Command.MiscDistanceToNextStation, CommandType.Digital, "MISC_DIST_NEXT_STATION") },
			...
			{ Command.MiscInterfaceMode, new CommandInfo(Command.MiscInterfaceMode, CommandType.Digital, "MISC_INTERFACE") },
			{ Command.MiscBackfaceCulling, new CommandInfo(Command.MiscBackfaceCulling, CommandType.Digital, "MISC_BACKFACE") },
