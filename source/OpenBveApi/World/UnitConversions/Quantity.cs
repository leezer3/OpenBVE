...
namespace OpenBveApi.World
{
	public static class Quantity
	{
		...
		public struct Area
		{
			...
			public UnitOfArea UnitValue
			{
				get;
			}

			public Area(double value) : this(value, UnitOfArea.SquareMeter)
			{
			}

			public Area(double value, UnitOfArea unitValue)
			{
				Value = value;
				UnitValue = unitValue;
			}
			...
			{
				return ToNewUnit(UnitOfArea.SquareMeter);
			}

			public Area ToNewUnit(UnitOfArea newUnitValue)
			{
				if (newUnitValue == UnitValue)
				{
					return this;
				...
				switch (UnitValue)
				{
					case UnitOfArea.SquareMeter:
						// Ignore
						break;
					case UnitOfArea.SquareCentimeter:
						factor *= System.Math.Pow(1.0e-2, 2.0);
						break;
					case UnitOfArea.SquareFoot:
			...
			{
				return TryParse(element, ignoreCase, UnitOfArea.SquareMeter, out quantity);
			}

			public static bool TryParse(XElement element, bool ignoreCase, UnitOfArea defaultUnitValue, out Area quantity)
			{
				double value;
				bool isSuccessValue = NumberFormats.TryParseDoubleVb6(element.Value, out value);

				UnitOfArea unitValue = defaultUnitValue;
				XAttribute unitAttribute = element.Attributes().FirstOrDefault(x => string.Equals(x.Name.LocalName, "Unit", ignoreCase ? StringComparison.InvariantCultureIgnoreCase : StringComparison.InvariantCulture));
				bool isSuccessUnit = true;
			...
			{
				return Parse(element, ignoreCase, UnitOfArea.SquareMeter);
			}

			public static Area Parse(XElement element, bool ignoreCase, UnitOfArea defaultUnitValue)
			{
				Area quantity;
		...
		public struct Length
		{
			...
			public UnitOfLength UnitValue
			{
				get;
			}

			public Length(double value) : this(value, UnitOfLength.Meter)
			{
			}

			public Length(double value, UnitOfLength unitValue)
			{
				Value = value;
				UnitValue = unitValue;
			}
			...
			{
				return ToNewUnit(UnitOfLength.Meter);
			}

			public Length ToNewUnit(UnitOfLength newUnitValue)
			{
				if (newUnitValue == UnitValue)
				{
					return this;
			...
			{
				return TryParse(element, ignoreCase, UnitOfLength.Meter, out quantity);
			}

			public static bool TryParse(XElement element, bool ignoreCase, UnitOfLength defaultUnitValue, out Length quantity)
			{
				double value;
				bool isSuccessValue = NumberFormats.TryParseDoubleVb6(element.Value, out value);

				UnitOfLength unitValue = defaultUnitValue;
				XAttribute unitAttribute = element.Attributes().FirstOrDefault(x => string.Equals(x.Name.LocalName, "Unit", ignoreCase ? StringComparison.InvariantCultureIgnoreCase : StringComparison.InvariantCulture));
				bool isSuccessUnit = true;
			...
			{
				return Parse(element, ignoreCase, UnitOfLength.Meter);
			}

			public static Length Parse(XElement element, bool ignoreCase, UnitOfLength defaultUnitValue)
			{
				Length quantity;
		...
		public struct Mass
		{
			...
			public UnitOfWeight UnitValue
			{
				get;
			}

			public Mass(double value) : this(value, UnitOfWeight.Kilograms)
			{
			}

			public Mass(double value, UnitOfWeight unitValue)
			{
				Value = value;
				UnitValue = unitValue;
			}
			...
			{
				return ToNewUnit(UnitOfWeight.Kilograms);
			}

			public Mass ToNewUnit(UnitOfWeight newUnitValue)
			{
				if (newUnitValue == UnitValue)
				{
					return this;
				...
				switch (UnitValue)
				{
					...
					case UnitOfWeight.Grams:
						factor *= 1.0e-3;
						break;
					case UnitOfWeight.MetricTonnes:
						factor *= 1.0e+3;
						break;
			...
			{
				return TryParse(element, ignoreCase, UnitOfWeight.Kilograms, out quantity);
			}

			public static bool TryParse(XElement element, bool ignoreCase, UnitOfWeight defaultUnitValue, out Mass quantity)
			{
				double value;
				bool isSuccessValue = NumberFormats.TryParseDoubleVb6(element.Value, out value);

				UnitOfWeight unitValue = defaultUnitValue;
				XAttribute unitAttribute = element.Attributes().FirstOrDefault(x => string.Equals(x.Name.LocalName, "Unit", ignoreCase ? StringComparison.InvariantCultureIgnoreCase : StringComparison.InvariantCulture));
				bool isSuccessUnit = true;
			...
			{
				return Parse(element, ignoreCase, UnitOfWeight.Kilograms);
			}

			public static Mass Parse(XElement element, bool ignoreCase, UnitOfWeight defaultUnitValue)
			{
				Mass quantity;
