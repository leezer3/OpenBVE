								...
								switch (Interface.CurrentControls[i].Command)
								{
									...
									case Translations.Command.TimetableUp:
										...
										if (TimeElapsed > 0.0)
										{
											...
											else if (OpenBveShared.Timetable.CurrentTimetable == TimetableState.Custom)
											{
...
#pragma warning restore 618
									...
									case Translations.Command.TimetableToggle:
										...
										if (Interface.CurrentOptions.TimeTableStyle == Interface.TimeTableMode.AutoGenerated || !OpenBveShared.Timetable.CustomTimetableAvailable)
										{
											//Either the auto-generated timetable has been selected as the preference, or no custom timetable has been supplied
											switch (OpenBveShared.Timetable.CurrentTimetable)
											{
												case TimetableState.Default:
													OpenBveShared.Timetable.CurrentTimetable = TimetableState.None;
													break;
												default:
													OpenBveShared.Timetable.CurrentTimetable = TimetableState.Default;
													break;
											}
											break;
										}
										if (Interface.CurrentOptions.TimeTableStyle == Interface.TimeTableMode.PreferCustom)
										{
											...
											if (OpenBveShared.Timetable.CurrentTimetable == TimetableState.None)
											{
