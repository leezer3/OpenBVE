...
namespace OpenBve
{
	public static partial class TrainManager
	{
		...
		internal abstract class Car : AbstractCar
		{
			...
			/// <summary>Updates the acceleration provided by the motor</summary>
			/// <param name="TimeElapsed">The time elapsed this frame</param>
			internal virtual void UpdateMotor(double TimeElapsed)
			{
			...
			internal double GetCriticalWheelSlipAccelerationForElectricMotor(double AdhesionMultiplier, double UpY, double Speed)
			{
			...
			internal double GetCriticalWheelSlipAccelerationForFrictionBrake(double AdhesionMultiplier, double UpY, double Speed)
			{
				double NormalForceAcceleration = UpY * Program.CurrentRoute.Atmosphere.AccelerationDueToGravity;
				// TODO: Implement formula that depends on speed here.
				double coefficient = Specs.CoefficientOfStaticFriction;
