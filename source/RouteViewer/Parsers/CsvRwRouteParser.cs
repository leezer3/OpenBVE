	...
	internal class CsvRwRouteParser {
		...
		internal static void ParseRoute(string FileName, bool IsRW, System.Text.Encoding Encoding, string TrainPath, string ObjectPath, string SoundPath, bool PreviewOnly) {
            ...
            if (!PreviewOnly) {
				...
				Data.Structure.Ground = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.WallL = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.WallR = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.DikeL = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.DikeR = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.FormL = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.FormR = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.FormCL = new Dictionary<int, ObjectManager.StaticObject>();
	            Data.Structure.FormCR = new Dictionary<int, ObjectManager.StaticObject>();
				Data.Structure.RoofL = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.RoofR = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.RoofCL = new Dictionary<int, ObjectManager.StaticObject>();
				Data.Structure.RoofCR = new Dictionary<int, ObjectManager.StaticObject>();
				Data.Structure.CrackL = new Dictionary<int, ObjectManager.StaticObject>();
				Data.Structure.CrackR = new Dictionary<int, ObjectManager.StaticObject>();
				Data.Structure.FreeObjects = new Dictionary<int, ObjectManager.UnifiedObject>();
				Data.Structure.Beacon = new Dictionary<int, ObjectManager.UnifiedObject>();
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														ObjectManager.UnifiedObject obj = ObjectManager.LoadObject(f, Encoding, ObjectManager.ObjectLoadMode.Normal, false, false, false);
														if (obj != null)
														{
															Data.Structure.RailObjects.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.Beacon.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.Ground.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.WallL.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.WallR.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.DikeL.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.DikeR.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.FormL.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.FormR.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														ObjectManager.StaticObject obj = ObjectManager.LoadStaticObject(f, Encoding, ObjectManager.ObjectLoadMode.Normal, false, false, false);
														if (obj != null)
														{
															Data.Structure.FormCL.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.FormCR.Add(CommandIndex1, obj);
														}
													}
												}
											}
												...
												if (Arguments.Length < 1) {
													...
													if (CommandIndex1 < 0) {
														...
														if (!System.IO.File.Exists(f)) {
															...
															ObjectManager.UnifiedObject obj = ObjectManager.LoadStaticObject(f, Encoding, ObjectManager.ObjectLoadMode.Normal, false, false, false);
															if (obj != null)
															{
																Data.Structure.RoofL.Add(CommandIndex1, obj);
															}
														}
													}
												}
												...
												if (Arguments.Length < 1) {
													...
													if (CommandIndex1 < 0) {
														...
														if (!System.IO.File.Exists(f)) {
															...
															if (obj != null)
															{
																Data.Structure.RoofR.Add(CommandIndex1, obj);
															}
														}
													}
												}
												...
												if (Arguments.Length < 1) {
													...
													if (CommandIndex1 < 0) {
														...
														if (!System.IO.File.Exists(f)) {
															...
															if (obj != null)
															{
																Data.Structure.RoofCL.Add(CommandIndex1, obj);
															}
														}
													}
												}
												...
												if (Arguments.Length < 1) {
													...
													if (CommandIndex1 < 0) {
														...
														if (!System.IO.File.Exists(f)) {
															...
															if (obj != null)
															{
																Data.Structure.RoofCR.Add(CommandIndex1, obj);
															}
														}
													}
												}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.CrackL.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.CrackR.Add(CommandIndex1, obj);
														}
													}
												}
											}
											...
											if (CommandIndex1 < 0) {
												...
												if (Arguments.Length < 1) {
													...
													if (!System.IO.File.Exists(f)) {
														...
														if (obj != null)
														{
															Data.Structure.FreeObjects.Add(CommandIndex1, obj);
														}
													}
												}
											}
										...
										if (!PreviewOnly) {
											...
											if (idx1 < 0) {
												...
												if (idx1 >= Data.Blocks[BlockIndex].Rail.Length || !Data.Blocks[BlockIndex].Rail[idx1].RailStart) {
													Interface.AddMessage(Interface.MessageType.Warning, false, "RailIndex1 " + idx1 + " could be out of range in Track.Form at line " + Expressions[j].Line.ToString(Culture) + ", column " + Expressions[j].Column.ToString(Culture) + " in file " + Expressions[j].File);
												}
								...
								case "track.crack":
									{
										if (!PreviewOnly) {
											...
											if (sttype < 0 || !Data.Structure.CrackL.ContainsKey(sttype) || !Data.Structure.CrackR.ContainsKey(sttype)) {
												...
												if (idx1 < 0) {
													Interface.AddMessage(Interface.MessageType.Error, false, "RailIndex1 " + idx1 + " is expected to be non-negative in Track.Crack at line " + Expressions[j].Line.ToString(Culture) + ", column " + Expressions[j].Column.ToString(Culture) + " in file " + Expressions[j].File);
												} else if (idx2 < 0) {
													Interface.AddMessage(Interface.MessageType.Error, false, "RailIndex2 " + idx2 + " is expected to be non-negative in Track.Crack at line " + Expressions[j].Line.ToString(Culture) + ", column " + Expressions[j].Column.ToString(Culture) + " in file " + Expressions[j].File);
												} else if (idx1 == idx2) {
													Interface.AddMessage(Interface.MessageType.Error, false, "RailIndex1 " + idx1 + " is expected to be unequal to Index2 in Track.Crack at line " + Expressions[j].Line.ToString(Culture) + ", column " + Expressions[j].Column.ToString(Culture) + " in file " + Expressions[j].File);
												} else {
													if (idx1 >= Data.Blocks[BlockIndex].Rail.Length || !Data.Blocks[BlockIndex].Rail[idx1].RailStart) {
			...
			for (int i = Data.FirstUsedBlock; i < Data.Blocks.Length; i++) {
				...
				if (!PreviewOnly) {
					for (int j = 0; j < Data.Blocks[i].GroundFreeObj.Length; j++) {
						...
						ObjectManager.CreateObject(Data.Structure.FreeObjects[sttype], wpos, GroundTransformation, new World.Transformation(Data.Blocks[i].GroundFreeObj[j].Yaw, Data.Blocks[i].GroundFreeObj[j].Pitch, Data.Blocks[i].GroundFreeObj[j].Roll), Data.AccurateObjectDisposal, StartingDistance, EndingDistance, Data.BlockInterval, tpos);
					}
				}
					...
					for (int j = 0; j < Data.Blocks[i].Rail.Length; j++) {
						...
						if (Data.Blocks[i].RailFreeObj.Length > j && Data.Blocks[i].RailFreeObj[j] != null) {
							for (int k = 0; k < Data.Blocks[i].RailFreeObj[j].Length; k++) {
								...
								ObjectManager.CreateObject(Data.Structure.FreeObjects[sttype], wpos, RailTransformation, new World.Transformation(Data.Blocks[i].RailFreeObj[j][k].Yaw, Data.Blocks[i].RailFreeObj[j][k].Pitch, Data.Blocks[i].RailFreeObj[j][k].Roll), -1, Data.AccurateObjectDisposal, StartingDistance, EndingDistance, Data.BlockInterval, tpos, 1.0, false);
							}
						}
						// transponder objects
						if (j == 0) {
