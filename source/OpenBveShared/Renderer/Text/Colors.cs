...
namespace OpenBveShared
{
	public static partial class Renderer
	{
		...
		public static void CreateBackColor(Color32 Original, MessageColor SystemColor, out float R, out float G, out float B, out float A)
		{
		...
		/// <param name="B">The blue component</param>
		/// <param name="A">The alpha component</param>
		public static void CreateTextColor(Color32 Original, MessageColor SystemColor, out float R, out float G, out float B, out float A)
		{
			if (Original.R == 0 & Original.G == 0 & Original.B == 0)
			{
				switch (SystemColor)
