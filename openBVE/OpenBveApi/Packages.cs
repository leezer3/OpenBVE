...
namespace OpenBveApi.Packages
{
	...
	public class Package
	{
		...
		[XmlIgnore] public Version PackageVersion;
		...
		[XmlElement(ElementName = "PackageVersion"), EditorBrowsable(EditorBrowsableState.Never), Browsable(false),
		 Bindable(false)]
		...
		[XmlIgnore] public Image PackageImage;
		...
		[XmlIgnore] public Version MinimumVersion;

		/// <summary>The minimum package version represented in string format</summary>
		[XmlElement(ElementName = "MinimumVersion"), Browsable(false), Bindable(false),
		...
		[XmlIgnore] public Version MaximumVersion;
	...
	/// <summary>This class is used by the XML serializer to provide a correctly readable structure</summary>
		...
		public static class Manipulation
		{
			...
			public static void ExtractPackage(Package currentPackage, string extractionDirectory, string databaseFolder,
				ref string packageFiles)
			{
			...
			public static void CreatePackage(Package currentPackage, CompressionType compressionType, string packageFile,
				string packageImage, List<PackageFile> packageFiles)
			{
			...
			{
				var fileList = OpenBveApi.Path.CombineFile(OpenBveApi.Path.CombineDirectory(databaseFolder, "Installed"),
					currentPackage.GUID.ToUpper() + ".xml");
					...
					while (reader.MoveToNextEntry())
					{
						...
						if (reader.Entry.Key.ToLowerInvariant() == "package.xml")
						{
							...
							SerializedPackage newPackage =
								(SerializedPackage)
									listReader.Deserialize(XmlReader.Create(OpenBveApi.Path.CombineFile(TempDirectory, "package.xml")));
		...
		public static class Information
		{
			...
			public static VersionInformation CheckVersion(Package currentPackage, List<Package> packageList,
				ref Package oldPackage)
			{
				if (packageList == null)
				{
			...
			public static List<Package> UpgradeDowngradeDependancies(Package currentPackage, List<Package> installedRoutes,
				List<Package> installedTrains)
			{
