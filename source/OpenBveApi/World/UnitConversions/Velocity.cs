...
namespace OpenBveApi.World
{
	...
	public class VelocityConverter : UnitConverter<UnitOfVelocity, double>
	{
		static VelocityConverter()
		{
			...
			{
				{"m/s", UnitOfVelocity.MetersPerSecond}, {"mph", UnitOfVelocity.MilesPerHour}, {"kmh", UnitOfVelocity.KilometersPerHour}, {"km/h", UnitOfVelocity.KilometersPerHour}, {"meterspersecond", UnitOfVelocity.MetersPerSecond}
			};
		}
