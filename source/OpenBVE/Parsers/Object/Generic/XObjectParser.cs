...
namespace OpenBve {
	internal static class XObjectParser {
		...
		// read object
		internal static StaticObject ReadObject(string FileName, System.Text.Encoding Encoding, ObjectLoadMode LoadMode) {
		...
		// load textual x
		private static StaticObject LoadTextualX(string FileName, string Text, System.Text.Encoding Encoding, ObjectLoadMode LoadMode) {
			// load
		...
		// load binary x
		private static StaticObject LoadBinaryX(string FileName, byte[] Data, int StartingPosition, int FloatingPointSize, ObjectLoadMode LoadMode) {
			// parse file
			AlternateStructure = false;
			LoadedMaterials = new Structure[] {};
			Structure Structure;
		...
		// process structure
		private static bool ProcessStructure(string FileName, Structure Structure, out StaticObject Object, ObjectLoadMode LoadMode) {
			System.Globalization.CultureInfo Culture = System.Globalization.CultureInfo.InvariantCulture;
