	...
	internal partial class Overlays
	{
		...
		private void RenderDebugOverlays()
		{
			...
			string[] Lines = {
				...
				"alpha faces: " + (Program.Renderer.VisibleObjects.PartialFaces.Count + Program.Renderer.VisibleObjects.AlphaFaces.Count).ToString(Culture),
				"overlay opaque faces: " + Program.Renderer.VisibleObjects.OverlayOpaqueFaces.Count.ToString(Culture),
				"overlay alpha faces: " + (Program.Renderer.VisibleObjects.OverlayPartialFaces.Count + Program.Renderer.VisibleObjects.OverlayAlphaFaces.Count).ToString(Culture),
