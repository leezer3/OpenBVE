...
namespace OpenBve.UserInterface
{
	...
	public partial class FormRaildriverCalibration : Form
	{
		...
		{
			InitializeComponent();
			main = (Bitmap)ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\raildriver.png"));
		...
		private void buttonCalibrationNext_Click(object sender, EventArgs e)
		{
			...
			{
				j.SaveCalibration(Path.CombineFile(Program.CurrentHost.FileSystem.SettingsFolder, "RailDriver.xml"));
				Close();
				return;
			}
			...
			switch (calibrationStage)
			{
				...
				case 1:
					...
					using (var graphics = System.Drawing.Graphics.FromImage(Modified))
					{
						...
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_down.png")), 234, 284);
					}
				...
				case 2:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(210, 130, 80, 145));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_up.png")), 234, 84);
					}
					pictureBox1.Image = Modified;
				...
				case 3:
					...
					using (var graphics = System.Drawing.Graphics.FromImage(Modified))
					{
						...
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_down.png")), 314, 284);
					}
					pictureBox1.Image = Modified;
				...
				case 4:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(290, 130, 90, 145));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_up.png")), 314, 84);
					}
					pictureBox1.Image = Modified;
				...
				case 5:
					...
					using (var graphics = System.Drawing.Graphics.FromImage(Modified))
					{
						...
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_down.png")), 470, 304);
					}
					pictureBox1.Image = Modified;
				...
				case 6:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(450, 130, 80, 165));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_up.png")), 470, 79);
					}
					pictureBox1.Image = Modified;
				...
				case 7:
					...
					using (var graphics = System.Drawing.Graphics.FromImage(Modified))
					{
						...
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_down.png")), 630, 304);
					}
					pictureBox1.Image = Modified;
				...
				case 8:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(610, 130, 75, 165));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_up.png")), 630, 79);
					}
					pictureBox1.Image = Modified;
				...
				case 9:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(610, 130, 75, 165));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_left.png")), 560, 175);
					}
					pictureBox1.Image = Modified;
				...
				case 10:
					...
					{
						graphics.DrawRectangle(new Pen(Color.Blue, 3.0f), new Rectangle(610, 130, 75, 165));
						graphics.DrawImage(ImageExtensions.FromFile(Path.CombineFile(Program.CurrentHost.FileSystem.DataFolder, "Menu\\arrow_right.png")), 690, 175);
					}
					pictureBox1.Image = Modified;
