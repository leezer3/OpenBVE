				...
				while (!reader.EndOfStream())
				{
					...
					switch (blockBitsPerSample)
					{
						...
						case 6:
							...
							break;
						default:
							throw new InvalidDataException("BlockBitsPerSample invalid");
					}
