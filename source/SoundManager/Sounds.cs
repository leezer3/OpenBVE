		...
		public void Initialize(SoundRange range)
		{
			...
			if (OpenAlDevice != IntPtr.Zero)
			{
				...
				if (OpenAlContext != ContextHandle.Zero)
				{
					...
					{
						MessageBox.Show(Translations.GetInterfaceString(CurrentHost.Application, "errors_sound_openal_version"), Translations.GetInterfaceString(CurrentHost.Application, "program_title"), MessageBoxButtons.OK, MessageBoxIcon.Hand);
					}
				...
				MessageBox.Show(Translations.GetInterfaceString(CurrentHost.Application, "errors_sound_openal_context"), Translations.GetInterfaceString(CurrentHost.Application, "program_title"), MessageBoxButtons.OK, MessageBoxIcon.Hand);
				return;
			}
			OpenAlContext = ContextHandle.Zero;
			MessageBox.Show(Translations.GetInterfaceString(CurrentHost.Application, "errors_sound_openal_device"), Translations.GetInterfaceString(CurrentHost.Application, "program_title"), MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}
