...
Version: $Version
Provides: bve-engine
Depends: debhelper (>= 9), mono-runtime (>= 3.2.8), libmono-corlib4.5-cil (>= 3.2.8), libmono-system-drawing4.0-cil (>= 1.0), libmono-system-windows-forms4.0-cil (>= 1.0), libmono-system4.0-cil (>= 3.2.8), libmono-system-xml-linq4.0-cil (>= 3.2.8), libmono-i18n4.0-all, libopenal1
