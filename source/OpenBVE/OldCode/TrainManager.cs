	...
	public static partial class TrainManager
	{
		...
		private static void UpdateSpeeds(Train Train, double TimeElapsed)
		{
			...
			for (int i = 0; i < Train.Cars.Length; i++)
			{
				...
				{
				    double a = Train.Cars[i].GetResistance(true);
				    double b = Train.Cars[i].GetResistance(false);
				...
				{
				    wheelSlipAccelerationMotorFront = Train.Cars[i].GetCriticalWheelSlipAccelerationForElectricMotor(true);
				    wheelSlipAccelerationMotorRear = Train.Cars[i].GetCriticalWheelSlipAccelerationForElectricMotor(false);
				    wheelSlipAccelerationBrakeFront = Train.Cars[i].GetCriticalWheelSlipAccelerationForFrictionBrake(true);
				    wheelSlipAccelerationBrakeRear = Train.Cars[i].GetCriticalWheelSlipAccelerationForFrictionBrake(false);
                    }
